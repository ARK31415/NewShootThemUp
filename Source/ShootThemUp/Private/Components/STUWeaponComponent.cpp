...
void USTUWeaponComponent::BeginPlay()
{
	...
	checkf(WeaponData.Num() == WeaponNum, TEXT("Our character can hole only %i Weapon items"), WeaponNum);
...
void USTUWeaponComponent::AttackWeaponToSocket(ASTUBaseWeapon* Weapon, USceneComponent* SceneComponent,
...
{
	auto EquipFinishedNotify = AnimUtil::FindNotifyByClass<USTUEquipFinishedAnimNotify>(EquipAnimMontage);
